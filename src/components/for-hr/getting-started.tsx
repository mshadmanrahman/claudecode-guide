    ...
    <section className="py-28 bg-fd-card" ref={ref}>
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid gap-8 sm:grid-cols-2">
          {/* What you need */}
          <div
            className={`transition-all duration-500 delay-100 ${inView ? "animate-slide-up-fade" : "opacity-0"}`}
          >
          ...
          {/* How it works */}
          <div
            className={`transition-all duration-500 delay-200 ${inView ? "animate-slide-up-fade" : "opacity-0"}`}
          >
            <h3 className="font-display text-lg font-medium text-fd-foreground mb-5">
              How it works
            </h3>
