 ...
 *
 * Extracted from the tutorials route on 2026-08-17 so that sitemap.ts can
 * derive tutorial slugs from the same source the route renders. Next.js
    ...
    steps: [
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I want to set up a CLAUDE.md file for my project. It's a Next.js app with TypeScript. Where do I start?",
            },
            {
              role: "claude",
              text: "Perfect starting point. A CLAUDE.md lives in your project root and tells me exactly how to work with your codebase.\n\nTell me a bit more:\n1. What does the project do?\n2. Any specific patterns or conventions your team follows?\n3. What do you want me to always/never do?",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "I want to set up a CLAUDE.md for this project. Can you look at my files and generate one?",
            },
            {
              role: "claude",
              text: "I can see your project structure. Next.js 16, TypeScript, Tailwind, Prisma for the database layer.\n\nI'll generate a CLAUDE.md based on what I can see. Give me a second to read through your key files.",
            },
          ],
        },
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "My project is a Next.js SaaS app with TypeScript and Tailwind. We use Prisma for the DB, vitest for tests, and prefer functional components. Never use `any` types.",
            },
            {
              role: "claude",
              text: "Here's your CLAUDE.md:\n\n---\n# CLAUDE.md\n\n## Stack\nNext.js (App Router), TypeScript (strict), Tailwind CSS, Prisma\n\n## Testing\nVitest : run with `npm test`\n\n## Conventions\n- Functional components only\n- No `any` types : use `unknown` and narrow\n- Immutable updates with spread operators\n---\n\nSave this as `CLAUDE.md` in your project root.",
            },
          ],
        },
        ideDemo: {
...
- Don't ask "would you like me to...". Just do it.`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "Your CLAUDE.md is now 24 lines of pure context.",
            },
            {
              type: "warn",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Add a section to the CLAUDE.md you just created: be concise, code first, TypeScript only, show root cause before fixing bugs, don't ask, just do.",
            },
            {
              role: "claude",
              text: "Added `## How I Work With You` section to `CLAUDE.md`. The file is saved and already active. I'll follow these preferences for the rest of this session.",
            },
          ],
        },
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "add a dark mode toggle to the header"',
            },
            ...
            {
              type: "success",
              text: "No config changes needed. Tailwind dark mode already enabled.",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Add a dark mode toggle to the header. My stack is Next.js 16, Tailwind, TypeScript.",
            },
            {
              role: "claude",
              text: "Here's a `ThemeToggle` component using `next-themes`:\n\n```tsx\n'use client';\nimport { useTheme } from 'next-themes';\nimport { Sun, Moon } from 'lucide-react';\n\nexport function ThemeToggle() {\n  const { theme, setTheme } = useTheme();\n  return (\n    <button onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}>\n      {theme === 'dark' ? <Sun /> : <Moon />}\n    </button>\n  );\n}\n```\n\nAdd `<ThemeToggle />` to your header. Tailwind dark mode should already be configured.",
            },
          ],
        },
        ideDemo: {
    ...
    steps: [
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I want to build a personal portfolio landing page. What information do you need from me?",
            },
            {
              role: "claude",
              text: "Just describe what you want and I'll generate the full HTML, CSS, and JS for you.\n\nTell me:\n1. Your name and tagline\n2. What sections you want (about, projects, contact?)\n3. Any style preferences : dark mode, minimal, bold, etc.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Create a new portfolio landing page project in this empty folder.",
            },
            {
              role: "claude",
              text: "Got it. Starting from scratch. I'll create `index.html`, `styles.css`, and `script.js` in this folder.\n\nQuick question: any name or tagline you want in the hero section, or should I use placeholders you can fill in later?",
            },
          ],
        },
      },
...
- Modern, clean aesthetic with subtle animations`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: '"Create a beautiful landing page for a personal portfolio..."',
            },
            ...
            {
              type: "out",
              text: "  Hero: gradient background, animated entrance",
            },
            {
              type: "out",
              text: "  About: two-column layout with avatar placeholder",
            },
            {
              type: "out",
              text: "  Projects: responsive card grid with hover effects",
            },
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "The hero font feels too thin. Make it bolder and increase the tagline font size.",
            },
            {
              role: "claude",
              text: "Updated CSS. Here's the change to make in your `styles.css`:\n\n```css\n.hero h1 {\n  font-weight: 700;  /* was 400 */\n  font-size: clamp(2.5rem, 6vw, 5rem);  /* was 3rem */\n}\n.hero .tagline {\n  font-size: 1.25rem;  /* was 1rem */\n}\n```\n\nJust find these selectors and swap the values.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "The hero font feels too thin. Make it bolder and increase the tagline size.",
            },
            {
              role: "claude",
              text: "Updated `styles.css`. Changed `font-weight` to 700 and increased the tagline to `1.25rem`. Refresh your browser to see the change.",
            },
          ],
        },
      },
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "index.html   : your complete landing page",
              delay: 300,
            },
        ...
        appDemo: {
          steps: [
            {
              role: "claude",
              text: "You now have 3 files. To preview: drag `index.html` into Chrome, or double-click it in Finder/File Explorer.\n\nReady to put it on the internet? I'll walk you through deploying to Vercel. It's free and takes 2 minutes.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "claude",
              text: "Files are in your workspace. Want me to start a local dev server so you can preview with hot reload?\n\nRun: `npx serve .`, or I can set up a proper live-reload environment.",
            },
          ],
        },
      },
...
npx serve .`,
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "How do I preview the files you just gave me?",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "I want to create a reusable skill for code reviews. Where do I put it?",
            },
            {
              role: "claude",
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: "36 lines of instructions. That's your whole skill.",
            },
          ],
        },
        appDemo: {
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "out",
              text: 'Without skill: "Here are some suggestions..."',
              delay: 400,
            },
            {
              type: "out",
              text: "  Generic advice, inconsistent format, misses things",
            },
            { type: "out", text: "" },
            {
              type: "success",
              text: "With skill: Structured review, severity ratings, exact fixes",
            },
            {
              type: "out",
              text: "  Same format every time. Never misses security checks.",
            },
            { type: "out", text: "" },
            {
              type: "warn",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "What's the difference between asking with and without the skill?",
            },
            {
              role: "claude",
              text: "Without the skill, I give you a general opinion. With it, I follow your exact format : severity ratings, file paths, line numbers, specific fixes.\n\nThe skill is a contract: it defines what a \"code review\" means in your project. I can't drift into vague suggestions or skip your team's rules. That consistency is what makes it useful at scale.",
            },
          ],
        },
      },
...
- All public functions need JSDoc comments`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Rate limiting, repo pattern, error boundaries...",
            },
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Add these team rules to the code review skill: rate limiting on all API routes, repository pattern for DB queries, error boundaries on React components, no inline styles, JSDoc on public functions.",
            },
            {
              role: "claude",
...
EOF`,
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I want to turn meeting notes into Jira tickets. Before I paste notes, here's my context: I'm a PM for a SaaS app, web + mobile. Tickets go in Jira project KEY. Story points: 1, 2, 3, 5, 8. Teams: frontend (React), backend (Node), mobile (React Native). Always include acceptance criteria as checkboxes.",
            },
            {
              role: "claude",
              text: "Got it. I'll use that context for every ticket I generate in this conversation.\n\nQuick format I'll follow:\n• Type: Story / Bug / Task\n• Points: 1, 2, 3, 5, 8\n• Labels: frontend, backend, design, mobile\n• Acceptance criteria: checkboxes\n\nPaste your meeting notes whenever you're ready.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Create a CLAUDE.md with PM context: SaaS product, web + mobile. Jira project KEY. Story points 1/2/3/5/8. Teams: frontend (React), backend (Node), mobile (React Native). Acceptance criteria as checkboxes.",
            },
            {
              role: "claude",
              text: "Created `CLAUDE.md` with your PM workspace context.\n\nI'll use this for the rest of the session. Any ticket I generate will follow your format and label structure. Ready for the meeting notes.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Output: structured tickets with acceptance criteria",
            },
            { type: "out", text: "" },
...
onboarding flow - users are dropping off at step 3."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Process these meeting notes into tickets: ..."',
            },
            {
              type: "out",
            ...
            {
              type: "out",
              text: "  AC: tap target size, tested on iOS+Android, regression test",
            },
            { type: "out", text: "" },
      ...
      "env": {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "success",
              text: "Created issue #142: Fix mobile checkout pay button",
            },
            {
              type: "success",
              text: "Created issue #143: Add Apple Pay integration",
            },
            {
              type: "success",
              text: "Created issue #144: Add product listing caching",
            },
            {
              type: "success",
              text: "Created issue #145: Spring sale homepage banner",
            },
            {
              type: "success",
              text: "Created issue #146: Optimize onboarding step 3",
            },
            { type: "out", text: "" },
            {
              type: "warn",
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Outcome: Increase weekly active usage 3.2 → 4.5 days",
            },
            { type: "out", text: "  Framework: Opportunity Solution Trees" },
            {
              type: "warn",
              text: "Claude now thinks in OSTs. Let's feed it data.",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I want to run product discovery using Teresa Torres' Opportunity Solution Tree framework. My product context: B2B SaaS project management tool, 2,400 active teams, 85% retention. Target outcome: increase weekly active usage from 3.2 to 4.5 days/week. I've done 12 customer interviews this cycle.",
            },
            {
              role: "claude",
              text: "Great framing. You've already done the hardest part by defining a measurable outcome. Let me make sure I'm using the OST framework correctly:\n\n🎯 **Outcome**: Weekly active usage 3.2 → 4.5 days/week\n\nFor everything we do in this session, I'll distinguish:\n- **Opportunities** = customer problems/needs/desires (what they experience)\n- **Solutions** = our ideas (what we might build)\n- **Assumption tests** = small experiments to validate before building\n\nPaste your first interview when ready. I'll extract the opportunities.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Create a CLAUDE.md for a product discovery workspace. B2B SaaS, 2400 active teams. Outcome: increase weekly active usage 3.2 → 4.5 days/week. Framework: OST (Teresa Torres). 12 interviews done, focus on why teams stop using mid-week.",
            },
            {
              role: "claude",
              text: "Created `CLAUDE.md` with your discovery context and OST framework reference.\n\nI'll use this throughout the session. All opportunity extraction will be anchored to your stated outcome. Ready for interview notes.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Guard: distinguishes opportunities from solutions",
            },
            {
              type: "warn",
...
old decisions. We started using a separate wiki just for that.'"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Extract opportunities from these interview notes..."',
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "1. Users can't distinguish signal from noise in notifications",
            },
            {
              type: "out",
              text: '   Source: Sarah, "notifications are overwhelming, people mute them"',
            },
            {
              type: "warn",
              text: "2. No way to see what changed since last visit",
            },
            {
              type: "out",
              text: '   Source: Sarah, "wish I could see just the things that changed"',
            },
            { type: "warn", text: "3. Can't take action from mobile" },
            {
              type: "out",
              text: '   Source: Sarah, "can\'t approve anything on my phone"',
            },
            { type: "warn", text: "4. Async teams blocked by timezone gaps" },
            {
              type: "warn",
              text: "5. No overnight activity summary for daily standups",
            },
            { type: "warn", text: "6. Past decisions are unfindable" },
            { type: "out", text: "" },
            {
              type: "success",
              text: "All framed as customer needs, not solutions.",
            },
          ],
        },
        appDemo: {
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "success",
              text: "🎯 OUTCOME: Weekly active usage 3.2 → 4.5 days/week",
            },
            { type: "out", text: "├── 🔍 Can't distinguish signal from noise" },
            {
              type: "out",
              text: "│   ├── 💡 Smart notification digest (batched, prioritized)",
            },
            {
              type: "out",
              text: '│   ├── 💡 "What\'s new" changelog per project',
            },
            {
              type: "out",
              text: "│   └── 💡 AI summary of overnight activity",
            },
            {
              type: "out",
              text: "│       └── 🧪 Riskiest: Will users read a daily digest email?",
            },
            ...
            {
              type: "out",
              text: "│   ├── 💡 Slack-based approvals (no app needed)",
            },
            { type: "out", text: "│   └── 💡 Email-reply approvals" },
            {
              type: "out",
              text: "│       └── 🧪 Riskiest: Is approval actually the main mobile action?",
            },
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Now build the full OST. For each of the 6 opportunities, brainstorm 3 solutions and identify the riskiest assumption for the most promising one.",
            },
            {
              role: "claude",
...
- Estimated effort"`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "Assumption: Users will open a daily digest email",
            },
            {
              type: "out",
              text: "Test: Send a manual digest email to 50 users for 5 days",
            },
            {
              type: "out",
              text: "Success: >40% open rate, >15% click-through to tool",
            },
            {
              type: "out",
              text: "Effort: 2 hours (manual email via Mailchimp)",
            },
            { type: "out", text: "" },
            { type: "warn", text: "## Test 2: Mobile Approval Flow" },
            {
              type: "out",
              text: "Assumption: Approval is the #1 mobile action needed",
            },
            {
              type: "out",
              text: 'Test: Survey 20 users. "What do you wish you could do on mobile?"',
            },
            { type: "out", text: "Success: >50% mention approvals unprompted" },
            {
              type: "out",
              text: "Effort: 1 hour (add question to next 20 interviews)",
            },
            { type: "out", text: "" },
            {
              type: "success",
              text: "Both tests runnable this week. Total effort: 3 hours.",
            },
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Design assumption tests for the smart notification digest and the mobile approval flow. For each: riskiest assumption, test I can run this week, success criteria with a number, estimated effort.",
            },
            {
              role: "claude",
...
forget it exists.'"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Update the OST with new findings..."',
            },
            {
              type: "out",
            ...
            {
              type: "success",
              text: 'Updated: "Can\'t distinguish signal from noise"',
            },
            {
              type: "out",
              text: '  Added evidence: "all look the same, can\'t tell if urgent"',
            },
            {
              type: "out",
              text: "  New solution: Priority-based notification styling",
            },
            { type: "out", text: "" },
            { type: "warn", text: "New opportunity discovered:" },
            {
              type: "out",
              text: '  🔍 "No trigger to return to the tool without @mentions"',
            },
            {
              type: "out",
              text: '  Source: Maria, "I only open when someone @mentions me"',
            },
            { type: "out", text: "" },
            {
              type: "success",
              text: "Tree updated: 7 opportunities, 21 solutions.",
            },
            {
              type: "warn",
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Create a communication plan from this. Weekly cadence. What should I say to each person and how often?",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Build a weekly communication plan for each stakeholder. Channel, frequency, what to say.",
            },
            {
              role: "claude",
      ...
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Draft a first outreach email to Aisha in Finance. I need Q3 budget approval. She doesn't know me yet.",
            },
            {
              role: "claude",
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Format everything as a clean markdown document I can paste into Notion.",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Format everything as a clean markdown document for Notion.",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: 'I run a weekly newsletter for product managers called "PM Pulse." It covers product strategy, interesting frameworks, and one tool worth trying. My audience is mid-to-senior PMs at tech companies. Tone is smart but not stuffy, like a sharp PM friend texting you.',
            },
            {
              role: "claude",
              text: 'Love the brief. "Smart PM friend texting you" is a great editorial voice to lock in.\n\nFor each issue I\'d suggest this structure:\n1. The insight (1 idea worth thinking about this week)\n2. The framework (a mental model or process, explained simply)\n3. The tool (one thing worth trying, with a real use case)\n\nDoes that match how you already run it? And should I write each section as short sharp takes, or longer explanations?',
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: 'I run a weekly newsletter called "PM Pulse" for mid-to-senior PMs. Smart tone, not stuffy. Structure: The Insight, The Framework, The Tool. Keep this context for our whole session.',
            },
            {
              role: "claude",
              text: "Saved. I'll use that voice and structure for everything we produce in this session.\n\nWhen you're ready, paste your sources for this week (URLs, article titles, or topics you've been thinking about) and I'll draft all three sections.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: "Claude knows what your stakeholders care about.",
            },
          ],
        },
        appDemo: {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Create CLAUDE.md: PM workspace, reporting weekly. Projects: Alpha (auth redesign, Q2), Beta (mobile v2, beta), Gamma (API perf). Stakeholders: VP Product (high-level+risks), Eng Director (technical), CEO (one sentence).",
            },
            {
              role: "claude",
              text: "Created `CLAUDE.md` with your project and stakeholder context.\n\nReady to generate reports. When you give me your weekly updates, I'll structure them per your stakeholder profiles. One format for the CEO one-pager, one for the VP, one for Eng Director.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Template: TL;DR, per-project status, metrics, decisions",
            },
            {
              type: "out",
              text: "  Rules: scannable, concrete, honest about risks",
            },
...
- Gamma: reduced API p95 from 800ms to 340ms. Still working on the search endpoint."`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: "Alpha: At risk. SSO complexity may push Q2 deadline.",
            },
            {
              type: "success",
              text: "Beta: On track. 200 testers, 0.3% crash rate.",
            },
            ...
            {
              type: "warn",
              text: "- Add extra sprint for SSO? (need VP approval by Wed)",
            },
            { type: "out", text: "" },
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Generate weekly status. Alpha: finished password reset, SSO started but more complex, might need extra sprint. Beta: 200 testers, crash 0.3%, Android push bug critical. Gamma: p95 800ms→340ms, search still in progress.",
            },
            {
              role: "claude",
              text: "Using `weekly-status` skill. Generated report:\n\n🟡 **Alpha**: At risk (SSO scope)\n🟢 **Beta**: On track (200 testers, 0.3% crash)\n🟢 **Gamma**: On track (p95 57% faster)\n\n**Decision needed**: Extra sprint for SSO → VP Product by Wed\n\nFull report formatted and ready. Want me to output the Slack version or email version too?",
            },
          ],
        },
      },
...
- End with "Let me know if you have questions"`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: ":large_yellow_circle: *Alpha*: SSO integration started, needs extra sprint",
            },
            {
              type: "success",
              text: ":large_green_circle: *Beta*: 200 testers, crash rate 0.3%",
            },
            {
              type: "success",
              text: ":large_green_circle: *Gamma*: API p95 down 57% to 340ms",
            },
            { type: "out", text: "" },
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Help me write a performance review for my direct report. Senior PM, annual review, company rubric: impact / execution / collaboration / growth.",
            },
            {
              role: "claude",
              text: "Got the structure. I'll need your raw observations before I draft anything. Paste your notes (bullet points are fine, messy is fine) and I'll turn them into a structured review across those four dimensions.",
            },
          ],
        },
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Priya's highlights: onboarding redesign shipped Q3, 40% activation improvement. Issues: changed requirements twice mid-sprint without change control, engineering team flagged tension both times. Strong technically, needs to grow cross-functionally.",
            },
            {
              role: "claude",
              text: "Understood. I have enough to draft across all four dimensions. The collaboration section will specifically name the change-control incidents. That's fair and actionable. Ready to generate the full draft.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Expand the Impact section. More narrative, explain why this was hard, not just what the outcome was.",
            },
            {
              role: "claude",
      ...
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Soften the collaboration section slightly. She's a strong performer overall, I don't want this to overshadow the rest.",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "I need a decision memo on auth system: rebuild from scratch vs. migrate to Auth0. Custom system is 4 years old, fragile, team hates it. Auth0 costs ~$2k/month. Rebuild = 3-4 months, same risks. Board review in 3 weeks.",
            },
            {
              role: "claude",
              text: "I have enough to structure this. The core tension is control/cost vs. maintenance drag. I'll build the memo with: problem statement, three options (rebuild, Auth0, hybrid), tradeoffs, and a recommendation.\n\nDo you want me to include a financial comparison, or keep it qualitative for now?",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Now generate the options section with honest tradeoffs.",
            },
            {
              role: "claude",
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Add a risk register and a sign-off section.",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Add risks, mitigations, and sign-off section.",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Competitive analysis for a B2B project management tool for agencies. Decision: build native time tracking or stay focused? Competitors: Asana, Monday.com, ClickUp, Teamwork (has time tracking).",
            },
            {
              role: "claude",
              text: "Understood. Paste what you know about your product and each competitor, or I can start from general knowledge and you correct the gaps. What dimensions matter most for this decision: feature depth, pricing, target customer, or positioning?",
            },
          ],
        },
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Our product: project mgmt for creative agencies. Differentiator: client portals + approval workflows. $25-50/user. No time tracking. Asana: no native time tracking. Monday: basic time tracking column. ClickUp: time tracking, feature-dense, confusing. Teamwork: agency-focused, full time tracking + invoicing.",
            },
            {
              role: "claude",
              text: "Key signal: Teamwork is the only direct competitor on both ICP (agencies) and time tracking. ClickUp has the feature but not the positioning. Your moat (client portals) is underserved by all four competitors.\n\nBuilding comparison matrix now across: target customer, time tracking depth, client collaboration, pricing, positioning.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Write the strategic summary with a recommendation on whether to build time tracking.",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Write the strategic summary with a recommendation on building time tracking.",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "I'm building a research brief on AI's impact on product management roles. Audience: leadership, making an investment case for PM AI tooling.",
            },
            {
              role: "claude",
              text: "Understood. I'll structure the brief for a leadership investment decision. Evidence, early adopter signals, risk of inaction, and a practical recommendation. Paste your sources.",
            },
          ],
        },
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: 'Sources: (1) Lenny\'s Newsletter : AI PMs 2-3x more productive on synthesis, judgment unchanged. (2) McKinsey : 40% of knowledge tasks automatable, synthesis highest impact. (3) A16z : "10x PM", faster discovery cycles. (4) Intercom Head of Product : 30% time savings on research/reporting, reinvested in customer interviews. (5) HBR : AI adopters gain learning advantage, non-adopters face skills erosion in 3-5 years.',
            },
            {
              role: "claude",
              text: "Good set. Practitioner, consulting, and academic perspectives covered. There's a useful tension: most sources are bullish on productivity, but HBR introduces a skills-erosion risk that makes the case more nuanced and credible. I'll surface that in the brief. Synthesising now.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Now synthesise across all five sources. What's the consensus, what are the tensions, and what does it mean for us?",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Board update deck. 20 minutes, 8 board members (operators + investors). Q1 results + Q2 priorities. Goal: confidence in business, clarity on next quarter investment.",
            },
            {
              role: "claude",
              text: "Got it. Two questions before I build the outline: (1) Is this a strong, mixed, or difficult quarter? The narrative arc changes completely. (2) Any politically sensitive topics to handle carefully (e.g. a miss, a leadership change, a strategic pivot)?",
            },
          ],
        },
      },
      {
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Mixed quarter. Revenue: $2.4M +18% YoY (hit plan). NRR: 102% vs 115% target. Lost 2 mid-market accounts to competitor. New product: 60 beta customers, strong NPS. Team: full strength. Q2: enterprise focus, fix mid-market retention, maintain product momentum. Need board approval: +$300k sales headcount.",
            },
            {
              role: "claude",
              text: 'Key story: strong top-line, one visible miss, response already framed. Classic "managed quarter" narrative.\n\nStructural note: surface the NRR miss proactively before they ask. Own it, frame the cause, pivot to Q2 response. The $300k ask lands best at the end as the logical conclusion of strategy, not as a standalone line item.\n\nBuilding narrative arc.',
            },
          ],
        },
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Build the narrative arc first, before the slides.",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            ...
            {
              role: "claude",
              text: '**Arc**: Open strong (revenue) → own the miss proactively (NRR) → pivot to momentum (product beta) → frame Q2 as the coherent response → close with headcount ask as logical conclusion.\n\nThe goal: board leaves thinking "they know their business, they have a plan, the ask makes sense" and not "what happened to NRR?"',
            },
          ],
        },
      },
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Write speaker notes for slide 4 (the NRR slide) and slide 7 (the ask). Those are the two I'm most nervous about.",
            },
            {
              role: "claude",
      ...
      },
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Build me a realistic savings plan. I want to hit £500/month consistently, not just in good months.",
            },
            {
              role: "claude",
    ...
    steps: [
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "cmd",
              text: '"Can you see my screen right now?"',
              delay: 400,
            },
            { type: "out", text: "Let me check... Activating computer use..." },
            {
              type: "success",
              text: "✓ I can see your screen. You're on the macOS desktop with Chrome and VS Code open.",
            },
            {
              type: "warn",
              text: "→ That's it. No setup, no config. It just works.",
            },
          ],
        },
        appDemo: {
          steps: [
            ...
            {
              role: "claude",
              text: "Yes! I can see your screen right now. You're on your desktop with a browser open showing Gmail and a Notion page in another tab.\n\nI can:\n- Click on things\n- Type into fields\n- Scroll through pages\n- Take screenshots for reference\n\nWhat would you like me to help with?",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Can you see my screen? I need help with something visual.",
            },
            {
              role: "claude",
              text: "Yes, I can see your screen. You have VS Code open with a React component, and there's a browser preview showing what looks like a broken layout - the sidebar is overlapping the main content.\n\nWant me to fix the CSS issue I can see?",
            },
          ],
        },
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: '"I have a Jira ticket open in my browser. Can you read it and create a summary?"',
            },
            { type: "out", text: "Looking at your screen..." },
            {
              type: "out",
              text: 'I can see JIRA-1234: "User authentication fails on mobile Safari"',
              delay: 400,
            },
            {
              type: "out",
            ...
            {
              type: "out",
              text: "  Bug: Safari mobile drops auth cookies after 30min idle",
            },
            { type: "out", text: "  Impact: ~2,400 mobile users/day affected" },
            { type: "out", text: "  Root cause: SameSite=Strict + Safari ITP" },
            {
              type: "out",
              text: "  Fix: Switch to SameSite=Lax with secure flag",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I have a spreadsheet open in Google Sheets. Can you read the data in columns A through D and tell me the top 3 spenders?",
            },
            {
              role: "claude",
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Look at the browser preview on the right. The button is cut off on mobile. Can you fix it?",
            },
            {
              role: "claude",
              text: 'I can see the issue - the "Submit" button is overflowing its container on the mobile viewport. The problem is a fixed width on the button that doesn\'t account for padding.\n\nLet me fix this in your component...\n\n```tsx\n// Before: w-[200px] causes overflow\n// After: w-full sm:w-auto\n<button className="w-full sm:w-auto px-6 py-3">\n```\n\nThe button will now be full-width on mobile and auto-sized on desktop. Check your preview - it should update.',
            },
          ],
        },
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: '"Open Chrome, go to our Figma file, screenshot the new design, then come back here and implement it"',
            },
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "out",
              text: "── Things people actually do with Computer Use ──",
            },
            {
              type: "success",
              text: '"Read this error message on screen and fix it"',
            },
            {
              type: "success",
              text: '"Fill out this form with my saved info"',
              delay: 300,
            },
            {
              type: "success",
              text: '"Compare these two browser tabs side by side"',
              delay: 300,
            },
            {
              type: "success",
              text: '"Take a screenshot of this bug and file an issue"',
              delay: 300,
            },
            {
              type: "success",
              text: '"Read the chart in this dashboard and summarize trends"',
              delay: 300,
            },
            {
              type: "success",
              text: '"Navigate to Settings > Privacy and turn off tracking"',
              delay: 300,
            },
            {
              type: "warn",
              text: "→ If you can see it on screen, Claude can see it too.",
            },
          ],
        },
        appDemo: {
    ...
    steps: [
      {
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I just switched from ChatGPT. Why does Claude feel like it starts from scratch every time?",
            },
            {
              role: "claude",
              text: "That is a really common first impression, and it is accurate. Claude does not have a built-in memory that follows you from one conversation to the next.\n\nThe fix is a file called CLAUDE.md. You write it once, and Claude reads it at the start of every session. It is like leaving yourself a briefing doc that Claude picks up automatically.\n\nWant me to help you build one? It takes about five minutes.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  I am a product manager. I prefer concise answers.",
            },
            ...
            {
              type: "warn",
              text: "Every future session will start with this context.",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Yes, help me build a CLAUDE.md. I'm a product manager. I want concise answers, British English spelling, bullet points over paragraphs, and no filler phrases like 'Certainly!'.",
            },
            {
              role: "claude",
              text: "Here is your CLAUDE.md. Save this as a file called `CLAUDE.md` in your home directory (or project folder):\n\n```\n# About Me\nI am a product manager.\nI prefer concise, direct answers with no preamble.\nAlways use British English spelling.\n\n# Communication Style\n- Bullet points over long paragraphs\n- Give the answer first, reasoning after\n- No filler phrases: skip 'Certainly!', 'Great question!', 'Of course!'\n```\n\nOnce this file exists, Claude reads it at the start of every new session. Your preferences stick automatically.",
            },
          ],
        },
      },
...
claude "write a three-bullet summary of what a product roadmap is"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "write a three-bullet summary of what a product roadmap is"',
            },
            { type: "out", text: "Reading ~/CLAUDE.md...", delay: 500 },
            {
              type: "out",
              text: "Context: PM, concise, British English, bullets first",
            },
            { type: "out", text: "" },
            { type: "out", text: "A product roadmap is:" },
            {
              type: "out",
              text: "- A prioritised plan of what to build and when",
            },
            {
              type: "out",
              text: "- A communication tool for aligning stakeholders on direction",
            },
        ...
        appDemo: {
          steps: [
            {
              role: "user",
              text: "Write a three-bullet summary of what a product roadmap is.",
            },
            {
              role: "claude",
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "Reading ~/CLAUDE.md (global)...",
              delay: 400,
            },
            {
              type: "out",
              text: "Reading ./CLAUDE.md (project)...",
              delay: 300,
            },
            {
              type: "success",
              text: "Loaded: PM preferences + Q3 roadmap context",
            },
            {
              type: "out",
              text: "Claude knows: your key files, the deadline, what is already decided.",
            },
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  - You want fast, conversational back-and-forth",
            },
            { type: "out", text: "  - You are browsing or on a phone" },
            {
              type: "out",
              text: "  - You want cross-session memory without setup",
            },
            {
              type: "out",
              text: "  - You are using GPT plugins or DALL-E image generation",
            },
            { type: "out", text: "" },
            { type: "out", text: "Use Claude Code when:", delay: 300 },
            {
              type: "out",
              text: "  - You are working inside a real project or folder",
            },
            {
              type: "out",
              text: "  - You want Claude to read, write, and edit actual files",
            },
            {
              type: "out",
              text: "  - You want repeatable workflows (skills, automations)",
            },
            {
              type: "out",
              text: "  - You want context that loads from your own machine",
            },
            {
              type: "success",
...
- No default exports from component files`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "success",
              text: "Context loaded. Claude will use this on every request.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Generate a CLAUDE.md for this Next.js TypeScript project. We use Vitest, Prisma, and Tailwind. Always run tests after refactoring. No any types. No console.log in production.",
            },
            {
              role: "claude",
              text: "I can see your project layout. Here is a CLAUDE.md that reflects your actual setup:\n\n```markdown\n## Stack\nNext.js 15 (App Router), TypeScript strict, Tailwind CSS, Prisma, Vitest\n\n## Commands\nnpm run dev   npm run build   npm test   npx tsc --noEmit\n\n## Conventions\n- Functional components, explicit prop interfaces\n- Server Components by default, use client only when needed\n- No any types, no console.log in production\n\n## Testing Rules\n- Run npm test after every refactor\n- Co-locate test files next to source\n```\n\nShall I write this to CLAUDE.md?",
            },
          ],
        },
      },
...
This happens when a user visits /courses/[id] without being logged in."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Fix this TypeError in enrollment.ts:47"',
            },
            ...
            {
              type: "out",
              text: "Root cause: session?.user is optional but line 47 accesses",
            },
            {
              type: "out",
              text: "userId directly. Pattern introduced in commit a3f92c1 (3 days ago).",
            },
            { type: "out", text: "" },
            {
              type: "out",
              text: "Fix: guard with early return when session is null.",
            },
            {
              type: "success",
...
tests passing. Do not change any external props interface."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Refactor UserCard: extract avatar into AvatarWithFallback"',
            },
            {
              type: "out",
            ...
            {
              type: "out",
              text: "  1. Extract avatar JSX into AvatarWithFallback.tsx",
            },
            {
              type: "out",
              text: "  2. Update UserCard to import AvatarWithFallback",
            },
            {
              type: "out",
              text: "  3. Keep UserCard props interface unchanged",
            },
            ...
            {
              type: "success",
              text: "22 passed, 0 failed. Refactor complete.",
            },
          ],
        },
        ideDemo: {
...
Identify the most likely cause. Then wait for my confirmation."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Stale data in CourseProgress. Trace the data flow first."',
            },
            {
              type: "out",
            ...
            {
              type: "out",
              text: "Recent change (2 days ago): added staleTime: Infinity",
            },
            {
              type: "out",
              text: "to React Query config in useCourseProgress.ts",
            },
            { type: "out", text: "" },
            {
              type: "warn",
              text: "Most likely cause: staleTime prevents refetch after mutation.",
            },
            {
              type: "warn",
              text: "Waiting for your confirmation before applying fix.",
            },
          ],
        },
        ideDemo: {
...
- Show root cause plus one-line explanation before the code change`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "cmd",
              text: 'claude "Add what we learned about staleTime to CLAUDE.md"',
            },
            ...
            {
              type: "warn",
              text: "Next time Claude sees a React Query query in this repo,",
            },
        ...
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Add what we just learned to CLAUDE.md: the staleTime issue, the session?.user guard pattern, and a preference to always trace data flow before suggesting fixes.",
            },
            {
              role: "claude",
...
After creating it, run npm run dev to confirm it starts."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Create a Next.js 16 project called dashboard-app..."',
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "Scaffold confirmed. Move to CLAUDE.md setup.",
            },
          ],
        },
        ideDemo: {
          steps: [
            {
              role: "user",
              text: "Create a Next.js 16 App Router project called dashboard-app. TypeScript strict mode, Tailwind CSS 4, src/ layout. Start with a minimal home page. Run dev and confirm it starts.",
            },
            {
              role: "claude",
              text: "Running `create-next-app` with your settings now.\n\nUsing:\n- App Router (not Pages)\n- `strict: true` in tsconfig\n- Tailwind v4 with the new CSS-based config\n- `src/app/` directory structure\n\nI will also add Prettier with the Tailwind class sort plugin since that pairs well with this setup.",
            },
            {
              role: "claude",
              text: "Done. Dev server confirmed at `localhost:3000`.\n\nProject structure:\n```\nsrc/\n  app/\n    layout.tsx\n    page.tsx\n    globals.css\n  components/   (empty, ready for your components)\n```\n\nNext: set up CLAUDE.md so I know your conventions for this project.",
            },
          ],
        },
      },
...
EOF`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  File naming: PascalCase components, camelCase utils",
            },
            ...
            {
              type: "warn",
              text: "Claude reads this at the start of every session.",
            },
          ],
        },
        ideDemo: {
...
6. Types everything properly with TypeScript interfaces"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Build a dashboard page with async data fetching..."',
            },
            { type: "out", text: "Reading CLAUDE.md...", delay: 400 },
            {
              type: "out",
              text: "Context: Server Components by default, named exports",
            },
            { type: "out", text: "" },
            ...
            {
              type: "warn",
              text: "No client components needed. Pure server rendering.",
            },
          ],
        },
        ideDemo: {
...
5. Then run: npx tsc --noEmit and fix any TypeScript errors"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Add Vitest tests and verify TypeScript..."',
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "All tests green. Strict mode clean. Ready to deploy.",
            },
          ],
        },
        ideDemo: {
...
gh pr diff 247 --name-only`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "success",
              text: "Branch checked out. You're now on the PR branch with full file context.",
            },
            {
              type: "warn",
              text: "Tip: run `gh pr view` to read the description before asking Claude to review.",
            },
          ],
        },
        ideDemo: {
...
# What are the biggest risks in this change?`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'gh pr diff 247 | claude "Review this PR. Focus on security and correctness. Refactor: sessions to JWTs."',
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "ISSUE: JWT secret read from process.env without a defined-check at startup",
            },
            {
              type: "warn",
              text: "ISSUE: Token expiry set to 30 days, no refresh token logic implemented",
            },
            {
              type: "warn",
              text: "ISSUE: logout() clears cookie but JWT stays valid until expiry",
            },
            { type: "out", text: "" },
            {
              type: "out",
              text: "Also noted: 4 API routes updated but 2 still use old session middleware",
            },
            {
              type: "success",
              text: "Full review complete. 3 blocking issues, 4 suggestions.",
            },
          ],
        },
        ideDemo: {
...
Their existing session cookies will not be valid. What is the transition path?"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Read src/auth/jwt.ts. What happens when a token is expired?"',
            },
            { type: "out", text: "Reading src/auth/jwt.ts...", delay: 500 },
            {
              type: "out",
              text: "Line 34: verifyToken() catches JsonWebTokenError and TokenExpiredError",
            },
            {
              type: "out",
              text: "Line 41: Both errors return null (no distinction between expired vs invalid)",
            },
            {
              type: "out",
              text: "Line 52: Middleware checks for null and calls next() with req.user = undefined",
            },
            {
              type: "warn",
              text: "PROBLEM: Expired token treated same as unauthenticated. No 401 returned.",
            },
            {
              type: "warn",
              text: "PROBLEM: req.user = undefined. Routes that skip the null check will crash.",
            },
            { type: "out", text: "" },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "src/api/profile/route.ts line 8: req.user.id accessed without null check",
            },
            {
              type: "success",
              text: "Root cause traced. This explains the 500 errors seen in staging.",
            },
          ],
        },
        ideDemo: {
...
npm test -- --testPathPattern auth/jwt`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "What\'s not tested in __tests__/auth/ that should be?"',
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "Untested: expired token returns null instead of a 401 response",
            },
            {
              type: "warn",
              text: "Untested: tampered signature (invalid JWT structure)",
            },
            {
              type: "warn",
              text: "Untested: concurrent requests during token refresh (race condition)",
            },
            {
              type: "warn",
              text: "Untested: malformed Authorization header format",
            },
            {
              type: "cmd",
              text: 'claude "Write the expired token test. Use the existing test setup."',
              delay: 600,
            },
            {
              type: "out",
            ...
            {
              type: "success",
              text: "4 tests passed. Expired token null return bug confirmed by tests.",
            },
          ],
        },
        ideDemo: {
...
gh pr review 247 --request-changes --body "$(cat review-draft.md)"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Draft a review comment for the JWT logout issue. Collegial tone, include a concrete fix."',
            },
            ...
            {
              type: "out",
              text: "The logout implementation clears the cookie correctly, but the JWT",
            },
            {
              type: "out",
              text: "itself stays valid until expiry (currently 30 days). If a token is",
            },
            {
              type: "out",
              text: "captured in a log or proxy before logout, it can be replayed after.",
            },
            { type: "out", text: "" },
            {
              type: "out",
              text: "Quickest fix: add the JTI to a Redis blocklist on logout and check",
            },
            {
              type: "out",
              text: "the blocklist in verifyToken(). The Redis client is already set up",
            },
            {
              type: "out",
              text: "in src/lib/redis.ts, so no new infrastructure needed.",
            },
            { type: "out", text: "---" },
            {
              type: "success",
              text: "Comment drafted. Copy to GitHub or pipe directly to gh pr review.",
            },
          ],
        },
        ideDemo: {
...
- Work entirely in the browser, no server needed`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "cmd",
              text: '"Build me a meme generator as a single HTML file..."',
              delay: 600,
            },
            ...
            {
              type: "warn",
              text: "Starting to build. This will take about 30 seconds.",
            },
          ],
        },
        appDemo: {
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: "Open meme-generator.html in your browser to try it.",
            },
          ],
        },
        appDemo: {
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: '  1. Click "Choose File" and pick any image',
            },
            { type: "out", text: "  2. Type your TOP TEXT and BOTTOM TEXT" },
            {
              type: "out",
              text: "  3. See the meme update live in the preview",
            },
            {
              type: "out",
              text: "  4. Click Download to save your meme as PNG",
            },
            {
              type: "warn",
              text: "Try it: upload a photo of your cat and caption it.",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I saved the file and opened it. The canvas is blank and nothing shows up when I type.",
            },
            {
              role: "claude",
              text: "You need to upload an image first. The canvas only renders once an image is loaded.\n\nSteps:\n1. Click the file input at the top\n2. Choose any image from your computer (JPG, PNG, WebP all work)\n3. Once the image appears on the canvas, start typing in the text fields\n\nThe preview updates live as you type. If you are on Safari and it still looks blank, try Chrome or Firefox.",
            },
            {
              role: "user",
              text: "Works! I uploaded a photo and the text appeared instantly. This is amazing.",
            },
            {
              role: "claude",
              text: "That is the Canvas API doing its thing. Every time you type a character, it redraws the entire canvas: image first, then text on top. The white fill and black stroke is the classic meme look (Impact font, outlined text).\n\nWant to make it better?",
            },
          ],
        },
      },
...
4. Drag-and-drop to reposition text on the canvas`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: '"Add a font size slider, color picker, 3 meme templates..."',
              delay: 200,
            },
            ...
            {
              type: "warn",
              text: "Reload the page in your browser to see the updates.",
            },
          ],
        },
        appDemo: {
...
Keep the gallery in memory (no server needed).`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: '"Add a meme gallery below the canvas..."',
              delay: 200,
            },
            {
              type: "out",
            ...
            {
              type: "warn",
              text: "Gallery resets on refresh. Want localStorage? Just ask.",
            },
          ],
        },
        appDemo: {
    ...
    steps: [
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "cmd",
              text: '"Analyze my playlist: Blinding Lights - The Weeknd, As It Was - Harry Styles, Levitating - Dua Lipa, Golden Hour - JVKE, Unholy - Sam Smith, Anti-Hero - Taylor Swift, Bad Guy - Billie Eilish, Watermelon Sugar - Harry Styles, Stay - The Kid LAROI, Peaches - Justin Bieber"',
              delay: 600,
            },
            { type: "out", text: "Analyzing 10 tracks...", delay: 800 },
            {
              type: "out",
              text: "Mood mapping: pop-forward, emotional range mixed",
            },
            {
              type: "out",
              text: "Energy distribution: high 60%, mid 30%, low 10%",
            },
            {
              type: "success",
              text: "Analysis complete. Building visual breakdown...",
            },
          ],
        },
        appDemo: {
          steps: [
            {
              role: "user",
              text: "I want to analyze my Spotify playlist. Can I just give you a list of songs and artists?",
            },
            {
              role: "claude",
              text: "Absolutely. Just paste your song list (name + artist is enough) and I will analyze the vibe, mood, energy levels, and tempo patterns across your whole playlist.\n\nNote: I work from my knowledge of these tracks, not live Spotify data, so well-known songs will get the richest analysis. Go ahead and paste your list.",
            },
          ],
        },
      },
...
Peaches - Justin Bieber`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "Tempo: mostly uptempo with a few midtempo breathers",
            },
            {
              type: "out",
              text: "Emotional arc: peaks early, stays elevated, softens at end",
            },
            {
              type: "out",
              text: "Pattern spotted: 4 of 10 tracks lean into nostalgic synthpop",
            },
            {
              type: "success",
              text: "Analysis ready. Now building your HTML visual...",
            },
          ],
        },
        appDemo: {
...
Use only HTML and CSS. No external libraries. I want to open it in my browser right now.`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Build me an HTML visual breakdown of this analysis. Dark theme, bar charts for energy, mood color swatches, no external libraries."',
            },
            ...
            {
              type: "warn",
              text: "Open in browser: open playlist-analysis.html",
            },
          ],
        },
        appDemo: {
...
- Make it look great in a dark card format, still HTML/CSS only`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Generate a shareable playlist personality card. Bold title, 3 stat badges, a roast-friendly one-liner. Dark card, HTML/CSS only."',
            },
      ...
      },
      {
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Recommend 5 songs that fit this playlist\'s vibe. Explain why each fits."',
            },
            {
              type: "out",
            ...
            {
              type: "out",
              text: "   Synthpop production, nostalgic tone, fits the arc perfectly",
            },
            { type: "out", text: "" },
            { type: "out", text: "2. Don't Start Now - Dua Lipa" },
            {
              type: "out",
              text: "   Disco-influenced uptempo, same confidence energy",
            },
            { type: "out", text: "" },
            { type: "out", text: "3. Save Your Tears - The Weeknd" },
            {
              type: "out",
              text: "   80s synthwave, bridges your existing Weeknd track",
            },
            { type: "out", text: "" },
            { type: "out", text: "4. Heat Waves - Glass Animals" },
            {
              type: "out",
              text: "   Indie-pop warmth, great midtempo break for the flow",
            },
            { type: "out", text: "" },
            { type: "out", text: "5. Electricity - Silk City ft. Dua Lipa" },
            {
              type: "out",
              text: "   Pure euphoric energy, completes the vibe loop",
            },
            {
              type: "success",
              text: "Done. Your playlist just got 5 tracks better.",
            },
          ],
        },
        appDemo: {
    ...
    steps: [
      {
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "out",
              text: "  Classic: World capitals, science facts, history dates",
            },
            {
              type: "out",
              text: "  Pop culture: Marvel movies, Taylor Swift, The Office",
            },
            {
              type: "out",
              text: "  Niche: Your city, your football club, your pet breed",
            },
            {
              type: "out",
              text: "  Weird: Obscure 90s cartoons, fast food menu items",
            },
            { type: "out", text: "" },
            {
              type: "warn",
              text: "Pro tip: the weirder the topic, the more shareable the quiz.",
            },
          ],
        },
        appDemo: {
...
Put everything in one file called office-quiz.html"`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Build me an HTML quiz game about The Office..."',
            },
...
Use their navy blue and grey color scheme. Add the company logo as text at the top."`,
        ...
        demo: {
          ...
          steps: [
            {
              type: "cmd",
              text: 'claude "Add a 20-second countdown timer to office-quiz.html"',
            },
            ...
            {
              type: "warn",
              text: "Refresh your browser. Timer starts immediately.",
            },
          ],
        },
        appDemo: {
...
# 4. Your URL: https://yourusername.github.io/your-repo-name`,
        ...
        demo: {
          ...
          steps: [
            ...
            {
              type: "warn",
              text: "Share that link anywhere. It works on every device.",
            },
          ],
        },
        appDemo: {
