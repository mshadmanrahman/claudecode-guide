...
function HomeOG() {
  return (
    ...
    >
      ...
      >
        Claude Code is Anthropic&apos;s AI coding assistant. This guide is the
        calm on-ramp for everyone learning it from scratch.
      </div>
      ...
      >
        {STATS.map((stat, i) => (
          ...
          >
            {i > 0 && (
              <div
                style={{ width: "1px", height: "36px", background: "#e5e5e5" }}
              />
            )}
            <div
            ...
            >
              <span
                style={{ fontSize: "36px", fontWeight: 700, color: "#0a0a0a" }}
              >
                {stat.value}
              </span>
              <span
                style={{ fontSize: "14px", color: "#a3a3a3", fontWeight: 500 }}
              >
                {stat.label}
              </span>
            </div>
