...
<img src="/blog-hero-catchup-codebase.png" alt="Illustration: developer returning to desk, floating git log cards in the air" style={{width:"100%",borderRadius:"12px",marginBottom:"2rem"}} />
