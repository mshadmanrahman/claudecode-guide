...
description: "CLAUDE.md for Python projects. Modern tooling only: uv, pytest, mypy, no bare requirements.txt."
---
...
4. Add framework-specific sections for Django, FastAPI, Flask, or whatever you're building on
