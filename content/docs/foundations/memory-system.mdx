...
description: "By default, Claude forgets everything when you close a session. The memory system fixes that. Here's how it works and how to set it up without overthinking it."
---
...
When memory grows large and you add specialized agents and scheduled jobs alongside it, the discipline shifts from what to save to what to keep out of context. The [subagent context-isolation pattern](/docs/foundations/subagent-context-isolation) covers the walls that make a growing system stay sharp.
