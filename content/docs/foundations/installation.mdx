...
<VocabBridge term="npm" explanation="Node Package Manager: a tool that downloads and installs programs for you, like an app store for developer tools.">npm</VocabBridge> will download and install Claude Code globally on your machine. You should see some progress text scroll by, and then it will finish.

### Troubleshooting on Mac

**"npm: command not found"** means Node.js isn't installed yet. Either download it from [nodejs.org](https://nodejs.org) or, if you use <VocabBridge term="Homebrew" explanation="A popular Mac tool that installs software from the command line: like an app store you type into.">Homebrew</VocabBridge>, run:
