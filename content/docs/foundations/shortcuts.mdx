...
description: "Every slash command, keyboard shortcut, CLI flag, and hook event in Claude Code. The three commands that alone save 30% on costs are buried in here."
---
