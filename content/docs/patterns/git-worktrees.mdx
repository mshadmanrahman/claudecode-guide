...
description: "Work on multiple branches at the same time without stashing anything. Git worktrees let Claude Code handle several tasks in parallel without stepping on itself."
---
...
| Scenario | Use | Why |
|---|---|---|
| Quick context switch (under 5 min) | `git stash` + branch | Faster setup |
