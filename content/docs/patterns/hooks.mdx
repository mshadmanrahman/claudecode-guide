---
title: Hooks
description: "This is where the real power is. Configure behaviors once, they run silently forever. Format on every edit, block secrets before they commit, load context at session start."
---
