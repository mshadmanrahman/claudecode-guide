...
<img src="/videos/gif-skill.gif" alt="Animated demo of creating a /commit skill" className="my-6 rounded-xl border border-fd-border shadow-sm" />
...
Start with one. The one you'll use tomorrow morning. That's your first skill.
