...
<img src="/gifs/gif-skill.gif" alt="Creating a /commit skill in Claude Code — one word, three steps, zero thinking" style={{borderRadius: '12px', border: '1px solid var(--fd-border)', width: '100%', maxWidth: '700px', margin: '24px 0'}} />
