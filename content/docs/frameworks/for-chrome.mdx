...
![A blueprint-style illustration of a browser with multiple tabs open, with lines connecting page content to a structured output, minimal line art on a grid background](/for-chrome/hero.png)
