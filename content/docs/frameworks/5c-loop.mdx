...
Each spoke takes 5C and translates it into one specific professional context, with real use cases, actual prompts, and the compound value specific to that role.

- [5C Loop for Operations](/docs/frameworks/for-operations): SOPs, exception reports, vendor communication, process documentation
- [5C Loop for Product Managers](/docs/frameworks/for-pms): PRDs, roadmap briefs, discovery readouts, OKR narratives, stakeholder updates
- [5C Loop for Teachers](/docs/frameworks/for-teachers): lesson plans, rubrics, student feedback, parent communication, assessment design
- [5C Loop for Marketers](/docs/frameworks/for-marketers): campaign briefs, performance reports, email sequences, creative briefs, launch content

---

The loop works because it closes. Start with [Foundations](/docs/foundations/) if you are still setting up your workspace, or go straight to the spoke for your role.
